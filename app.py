...
import os
import diskcache
from dash import Dash, DiskcacheManager, Input, MATCH, Output, State, ctx, no_update, html
from dash.exceptions import PreventUpdate

import employee_scheduling
import utils
from app_configs import (APP_TITLE, THEME_COLOR, THEME_COLOR_SECONDARY, LARGE_SCENARIO, MEDIUM_SCENARIO, MIN_MAX_EMPLOYEES, SMALL_SCENARIO)
...
def run_optimization(
    ...
    bqm = employee_scheduling.build_bqm(
        availability,
        shifts,
        *shifts_per_employee,
        *employees_per_shift,
    ...
    sol, errors = employee_scheduling.run_bqm(bqm)
    sched = utils.build_schedule_from_sample(sol, employees)
